...
int main (int argc, char* argv[]) {
    ...
    printf ("Serving Crap Since Yesterday\n");
...
void serveHTML(int socket) {
    const char* message =
        ...
        "<!DOCTYPE html>\n"
        "<html>\n"
        "   <head><title>...</title><style>body {background-color: #171717; font-size: 6rem; color: white; text-align: center;}</style></head>\n"
        "   <body>HI THIS IS MY POEM<br>READ IT HERE<br>OR BEWARE<br>THE CONSEQUENCES MAY BE SEVERE</body>\n"
        "</html>\n";
